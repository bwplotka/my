...
Since then I fell in love in open source work and started to learn the things I am sharing in this post by *observing*
...
There might be different reasons behind such a mistake. Maybe the maintainer was too tired or simply did not see that
...
unnecessary complexity or bugs. Avoid big PRs by splitting and chaining smaller ones or maintain functional commits. That latter
is quite harder to maintain and not obvious.
...
The reason is that openness is extremely powerful. When you move all, even your Maintainer Team discussions to public, everyone can learn, get context, get easily involved,
motivated, and up to date. Last but not least, you can avoid confusions like [this.](https://github.com/prometheus/prometheus/pull/6760#issuecomment-583733400)
...
Having extensive documentation is the key. But there are more ways to encourage your users to grab the latest build without fear and
deploy your code early! One way of doing it, is [building docker image on each merge to master](https://github.com/thanos-io/thanos/blob/master/.circleci/config.yml#L59)
...
saying sorry, and **removing a powerful feature** that is causing problems and confusion. For example [we had to remove gossip
...
Reuse have many potential advantages:

* You [LEARN!](https://twitter.com/bwplotka/status/1216693249055887360)
* You immediately hook into the ecosystem (e.g. by sharing API). This means you can reuse same integrations and tools!
...
maintainer of Prometheus itself (: In the end, I am helping with much more than just parts that
...
amazing contributions and becames another maintainer someday!**
...
Is something not done yet, is it in the experimental stage, or is it not tested properly? **Explicitly** mention it.
You don't want some huge customer to report that they lost millions because something in your project lost data. Obviously, it's their
legal responsibility – it's an open source project after all. But you want to make sure that users know what are the best practices and where
to be very careful.
...
and the truth was the opposite. While I felt super shitty and embarrassed about this, my whole team was laughing. When I look at it now... it did not matter (:
...
A rested and clear mind will solve problems 100x faster. Don't sacrifice weekends, sleep 8 hours, do sports.
...
career.** I definitely don't recommend this! Just because of too high expectations towards myself, overworking, ambitions, etc.

### Have fun!

Open Source is fun place. If you spend some of your work or free time at forums, GitHub Issues and working with the community, it's
